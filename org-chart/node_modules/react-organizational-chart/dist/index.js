...
function TreeNode(_a) {
    ...
    return (React.createElement(NodeContainer, { className: className },
        label,
        React.Children.count(children) > 0 && (React.createElement(ChildrenContainer, null, children))));
}
...
function Tree(_a) {
    ...
    return (React.createElement(StyledRootContainer, __assign({}, props),
        React.createElement(TreeNode, { label: label }, children)));
}
var Tree$1 = React.memo(Tree);
